...
export const generateStoreMaps = <StateValueType>(storeKey: string): StoreMapObjectType<StateValueType> => ({
    getValue: (state: StoreObjectType<StateValueType>): StateObjectType<StateValueType> => deepGet(state, [storeKey]),
    getKeyValue: (state: StoreObjectType<StateValueType>, key: string | number): StateValueType =>
        deepGet(state, [storeKey, key]),
    getKeysValue: (state: StoreObjectType<StateValueType>, keys: string[]): StateObjectType<StateValueType> => {
