...
const InstagramProfilePicture: React.FunctionComponent<IntagramProfilePicturePropsType> = ({
    picture,
}) =>
    picture ? (
        <AsyncImage
...
const InstagramMostRecent: React.FunctionComponent<IntagramMostRecentPropsType> = ({ media }) => {
    ...
    const mostRecent = Object.values(media || {}).sort(
        (a: InstagramMediaStateType, b: InstagramMediaStateType): number =>
